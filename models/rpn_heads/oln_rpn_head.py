...
from ..utils.nn_utils import normal_init
...
class OlnRPNHead(RPNHead):
    ...
    def __init__(self, loss_objectness, objectness_type='Centerness', **kwargs):
        ...
        if self.train_cfg:
            ...
            if self.sampling and self.train_cfg['objectness_sampler']:
    ...
    def _get_targets_single(self,
        ...
        if len(pos_inds) > 0:
            ...
            bbox_targets[pos_inds[valid_targets.cpu()], :] = (
                pos_bbox_targets[valid_targets.cpu()])
            bbox_weights[pos_inds[valid_targets.cpu()], :] = 1.0
